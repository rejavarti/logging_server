...
echo "🐳 Enhanced Universal Logging Platform - Docker Container Starting..."
...
if [ ! -f "$SETUP_COMPLETE_FILE" ] || [ ! -f "$ENV_FILE" ]; then
    ...
    if [ -n "$AUTH_PASSWORD" ]; then
        echo "✅ AUTH_PASSWORD found in environment - proceeding with automatic setup"
...
EOF
        ...
        echo "⚠️  No AUTH_PASSWORD environment variable found"
        echo "🎮 Starting interactive setup wizard..."
        echo ""
        echo "🌐 Please open http://localhost:10180 in your browser to complete setup"
        echo "📋 Or set AUTH_PASSWORD environment variable for automatic setup"
        echo ""
    ...
    echo "✅ Setup already completed - starting main server"
