...
LABEL maintainer="Rejavarti <rejavarti@github.com>" \
      ...
      org.opencontainers.image.documentation="https://hub.docker.com/r/rejavarti/rejavartis_logging_server" \
      org.opencontainers.image.source="https://github.com/rejavarti/logging-server" \
